...
$sql = "UPDATE 2may SET Attendance_number=:Attendance_number, japanese=:japanese, arithmetic=:arithmetic, english=:english, updated_at=now() WHERE id=:id";
