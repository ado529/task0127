...
$sql = 'INSERT INTO 2may(id, Attendance_number, japanese, arithmetic, english, created_at, updated_at) VALUES(NULL, :Attendance_number, :japanese, :arithmetic, :english, now(), now())';
...
header("Location:2may_input.php");
exit();
