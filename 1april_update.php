...
$sql = "UPDATE 1april SET Attendance_number=:Attendance_number, japanese=:japanese, arithmetic=:arithmetic, english=:english, updated_at=now() WHERE id=:id";
...
header("Location:1april_read.php");
exit();
